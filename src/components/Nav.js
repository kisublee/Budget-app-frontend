          ...
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            ...
            {isMobile ?  
             ...
             <MenuIcon />
              ...
              {menuItems.map((menuItem) => {
                  ...
                  return (
                      <Link to={pageURL} style={{textDecoration:"none", color:"black"}} key={menuTitle}>
                    <MenuItem onClick={() => handleMenu(pageURL)} sx={{"&:hover": {
            ...
            <div >
               {menuItems.map((menuItem) => {
                  ...
                  return (
                      <Link to={pageURL} style={{textDecoration:"none", color:"black"}} key={menuTitle}>
                    <Button variant='text' sx={{color:"white"}} onClick={() => handleMenu(pageURL)} >
                      {menuTitle}
                    </Button>
                    </Link>
                  );
